...
class ThreadsFeedScraper:
            ...
            for post_elem in post_elements:
                try:
                    ...
                    if text.strip() and text != author:
                        ...
                        self._print_post_info(new_posts_count, text)
    ...
    def _print_post_info(self, count: int, text: str) -> None:
        """Print formatted post information - simplified to show only content"""
        print(f"\n  ✓ Post #{count}")
        print(f"  {text}")
        print("-" * 60)
